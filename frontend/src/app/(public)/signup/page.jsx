            ...
            <form action={action} autoComplete="off">
                ...
                <main>
                    ...
                    <div className="passwordChecker">
                        <p className={password.search(/[A-Z]/) !== -1 ? 'validate' : ''}>One uppercase character</p>
                        <p className={password.search(/[a-z]/) !== -1 ? 'validate' : ''}>One lowercase character</p>
                        <p className={password.search(/[0-9]/) !== -1 ? 'validate' : ''}>One number(0-9)</p>
                        <p className={password.search(/[`~!@#$%^&*)(?.><]/) !== -1 ? 'validate' : ''}>One special character</p>
