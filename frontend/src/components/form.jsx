...
export default function Form({ onFormSubmit, initValue }) {
    ...
    return (
        <div className="form">
            <form action={action} className="row row-cols-1 row-cols-md-2 row-cols-lg-3 gy-2" readOnly={true}>
                <div className="col">
                    <div className="input-group">
                        <label htmlFor="type" className="input-group-text">Type</label>
                        <select id="type" name="type" className="form-select" defaultValue={value?.type} key={value?.type}>
                ...
                <div className="col">
                    <div className="input-group">
                        ...
                        <select className="form-select" id="status" name="status" defaultValue={value?.status} key={value?.status}>
                ...
                <div className="col">
                    <div className="input-group">
                        ...
                        <select className="form-select" id="category" name="categoryId" defaultValue={value?.categoryId} key={value?.categoryId} required>
                            {
                                category.map(c => (
                ...
                <div className="col">
                    <div className="input-group">
                        ...
                        <input type="number" className="form-control" id="amount" name="amount" defaultValue={value.amount} required={true} />
                    </div>
                </div>
                ...
                <div className="col">
                    <div className="input-group">
                        ...
                        <input type="text" className="form-control" id="description" name="description" defaultValue={value.description} required />
                    </div>
                </div>
