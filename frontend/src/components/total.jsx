...
export default function Total() {
  ...
  return (
    <div
      ...
      className="row justify-content-around align-items-center gx-3 p-2 my-2 bg-secondary-subtle border"
    >
      ...
      <button className="w-auto btn btn-sm btn-success ms-4" onClick={checkBalance}>
