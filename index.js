...
app.use(express.static(path.join(__dirname, process.env.MY_BUILD_DIR)));
...
app.use('*', (req, res) => res.sendFile(path.join(__dirname, process.env.MY_BUILD_DIR, 'index.html')));
